...
import bixi.hbase.query.location.BixiLocationQueryS13;

public class TestCase4LocationS13 extends TestCaseBase{
	@Override
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS13();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS13 tests = new TestCase4LocationS13();
