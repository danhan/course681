...
import bixi.hbase.query.location.BixiLocationQueryS15;

public class TestCase4LocationS15 extends TestCaseBase{
	@Override
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS15();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS15 tests = new TestCase4LocationS15();
