...
import bixi.hbase.query.location.BixiLocationQueryS25;

public class TestCase4LocationS25 extends TestCaseBase{
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS25();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS25 tests = new TestCase4LocationS25();
