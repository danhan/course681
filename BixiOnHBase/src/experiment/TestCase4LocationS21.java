...
import bixi.hbase.query.location.BixiLocationQueryS21;

public class TestCase4LocationS21 extends TestCaseBase{
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS21();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS21 tests = new TestCase4LocationS21();
