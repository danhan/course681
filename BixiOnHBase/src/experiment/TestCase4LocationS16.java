...
import bixi.hbase.query.location.BixiLocationQueryS16;

public class TestCase4LocationS16 extends TestCaseBase{
	@Override
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS16();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS16 tests = new TestCase4LocationS16();
