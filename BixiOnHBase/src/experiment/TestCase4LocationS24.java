...
import bixi.hbase.query.location.BixiLocationQueryS24;

public class TestCase4LocationS24 extends TestCaseBase{
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS24();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS24 tests = new TestCase4LocationS24();
