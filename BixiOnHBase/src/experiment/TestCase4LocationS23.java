...
import bixi.hbase.query.location.BixiLocationQueryS23;

public class TestCase4LocationS23 extends TestCaseBase{
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS23();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS23 tests = new TestCase4LocationS23();
