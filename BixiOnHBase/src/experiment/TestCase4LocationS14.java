...
import bixi.hbase.query.location.BixiLocationQueryS14;

public class TestCase4LocationS14 extends TestCaseBase{
	@Override
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS14();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS14 tests = new TestCase4LocationS14();
