...
import bixi.hbase.query.location.BixiLocationQueryS12;

public class TestCase4LocationS12 extends TestCaseBase{
	@Override
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS12();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS12 tests = new TestCase4LocationS12();
