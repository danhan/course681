...
import bixi.hbase.query.location.BixiLocationQueryS11;

public class TestCase4LocationS11 extends TestCaseBase{
	@Override
	...
	QueryAbstraction getBixiLocationQuery(){
		return new BixiLocationQueryS11();
	}
	
	public static void main(String[] args){
		
		TestCase4LocationS11 tests = new TestCase4LocationS11();
