...
public class BixiQuerySchema4 extends BixiQueryAbstraction {

	public BixiQuerySchema4(int type){
		super(4);
	}
	...
	public void queryAvgUsageByTimeSlot4Stations(String start, String end,
		...
		try{
		    BixiClient client = new BixiClient(conf,4);
		    Map<String, Double> avgusage = client
		        .copGetAvgUsageForPeriod4S3(stationIds, start, end,BixiConstant.FAMILY_NAME_4_DYNAMIC_VERSION);
